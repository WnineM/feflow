...
const {Loading, usePlugin} = require('../utils');
...
class Feflow {
  ...
  constructor(args) {
    ...
    this.utils = {
      chalk: chalk,
      Loading: Loading,
      usePlugin: function(pluginName, pluginCmd){
        return usePlugin(pluginName, pluginCmd, self, args);
      }
    };
  }
